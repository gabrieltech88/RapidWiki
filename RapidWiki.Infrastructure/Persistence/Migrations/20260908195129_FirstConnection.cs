        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Procedimentos_Usuarios_AutorId",
                        column: x => x.AutorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioDepartamentos", x => new { x.DepartamentosId, x.UsuariosId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ProcedimentoDepartamentos",
                columns: table => new
                {
                    DepartamentosId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ProcedimentosId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedimentoDepartamentos", x => new { x.DepartamentosId, x.ProcedimentosId });
                    table.ForeignKey(
                        name: "FK_ProcedimentoDepartamentos_Departamentos_DepartamentosId",
                        column: x => x.DepartamentosId,
                        principalTable: "Departamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProcedimentoDepartamentos_Procedimentos_ProcedimentosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcedimentoDepartamentos_ProcedimentosId",
                table: "ProcedimentoDepartamentos",
                column: "ProcedimentosId");

            migrationBuilder.CreateIndex(
                name: "IX_Procedimentos_AutorId",
                table: "Procedimentos",
                column: "AutorId");
